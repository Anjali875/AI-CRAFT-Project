    ...
    <footer className="bg-blush border-t border-divider mt-16">
      <div className="max-w-6xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-body">
            <li><Link to="/health-library" className="hover:text-pcos">PCOS Guide</Link></li>
            <li><Link to="/health-library" className="hover:text-pcos">Endometriosis Guide</Link></li>
            <li><Link to="/screening" className="hover:text-pcos">Symptom Checker</Link></li>
          </ul>
        </div>
      </div>
      <div className="border-t border-divider py-4 text-center text-xs text-body">
        © 2026 Women's Health AI. All rights reserved. ·{" "}
        <Link to="/about" className="hover:text-pcos">Disclaimer</Link>
      </div>
    </footer>
  );
}